    ...
    $.fn.socialSharePrivacy = function (settings) {
        var defaults = {
            'services' : {
                'facebook' : {
                    'status'            : 'on',
                    'dummy_img'         : '../../core/backend/admin/modules/share_buttons/socialshareprivacy/images/dummy_facebook.png',
                    'perma_option'      : 'on',
                    'referrer_track'    : '',
                    'action'            : 'recommend',
                    'layout'            : 'button_count',
                    'sharer'            : {
                        'status'        : 'off',
                        'dummy_img'     : '../../core/backend/admin/modules/share_buttons/socialshareprivacy/images/dummy_facebook_share_de.png',
                        'img'           : '../../core/backend/admin/modules/share_buttons/socialshareprivacy/images/dummy_facebook_share_active_de.png'
                    }
                },
                'twitter' : {
                    'status'            : 'on',
                    'dummy_img'         : '../../core/backend/admin/modules/share_buttons/socialshareprivacy/images/dummy_twitter.png',
                    'perma_option'      : 'on',
                    'referrer_track'    : '',
